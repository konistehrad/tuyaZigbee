...
#define IMAGE_TYPE_SWITCH_0042              (0x22 | (IMAGE_TYPE_BOOT_FLAG << 7))
#define IMAGE_TYPE_SWITCH_0043              (0x23 | (IMAGE_TYPE_BOOT_FLAG << 7))
#define IMAGE_TYPE_SWITCH_0044              (0x24 | (IMAGE_TYPE_BOOT_FLAG << 7))
